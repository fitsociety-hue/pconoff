...
exec(command, { encoding: 'utf-8', maxBuffer: 1024 * 1024 * 5 }, (error, stdout) => {
    ...
    for (const block of eventBlocks) {
        ...
        if (idMatch && timeMatch) {
            ...
            // let's also print raw system time string
            console.log(`Event ${id} raw: ${timeMatch[1]}, parsed: ${timeStr}`);
        }
    }
});
